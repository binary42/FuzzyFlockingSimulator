 ...
 * Once the predator eats enough birds to satisfy its hunger, it is removed
 * from the map. 
 *
...
class Predator extends Bird {
     ...
     *
     * @param  hunger How many birds should this predator eat before being removed from the map.
     */
